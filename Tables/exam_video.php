...
class Tables_exam_video  extends Tables_Model {
		...
		public function getVideo_author(){
			return self::$_data ['video_author'];
		}
		...
		public function setVideo_author($value){
			return self::$_data ['video_author'] = $value;
			$this;
		}
